...
parser = argparse.ArgumentParser(description='Dynamic-CSD')
...
parser.add_argument('--threshold', type=str, default='', help='threshold for dynamic-CSD')
...
args.threshold = list(map(lambda x: float(x), args.threshold.split(',')))
